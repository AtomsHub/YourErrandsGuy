...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>YourErrandsGuy - Customers</title>
        ...
        <section class="main-content flex-grow-1">
            <div class="p-0 h-100 d-flex align-items-stretch">
                ...
                <div class="dashboard-content p-3 p-md-4">
                    ...
                    <h5 class="headline-small pt-4 mb-3">Customer List</h5>
                        ...
                        <div class="col">
                            <div class="rounded-col table-responsive">
                                <table class="table table-hover" id="ride">
                                    ...
                                    <tbody>
                                        <tr onclick="window.location.href='customer.html'">
                                            <td>#675895</td>
                                            <td>23 Jul 2024 12:32 AM</td>
                                            <td>Olayinka Akanbi</td>
