...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>YourErrandsGuy - Customer</title>
        ...
        <section class="main-content flex-grow-1">
            <div class="p-0 h-100 d-flex align-items-stretch">
                ...
                <div class="sidebar offcanvas-md offcanvas-end" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
                    ...
                    <div class="top-sidebar">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <a href="../customers/" class="d-flex align-items-center gap-4 active">
                ...
                <div class="dashboard-content p-3 p-md-4">
                    ...
                    <h5 class="headline-small mb-1 pt-4">Customer Details</h5>
                    <p class="label-medium mb-4">Customer ID #675895</p>
                    ...
                    <div class="row gap-4">
                        <div class="col-12">
                            <div class="rounded-col">
                                <div class="d-flex gap-2 align-items-center">
                                    ...
                                    <div class="">
                                        <h3 class="text-p fw-bold">Sodiq Oladiti</h3>
                        ...
                        <div class="col-12">
                            <div class="row flex-row-reverse gy-4">
                                    ...
                                    <div class="row row-cols-2 row-cols-md-1 gy-4">
                                        ...
                                        <div class="col">
                                            <div class="dashboard-card">
                                                <p class="dashboard-card_subtitle">No of Order</p>
                                        ...
                                        <div class="col">
                                            <div class="dashboard-card">
                                                <p class="dashboard-card_subtitle">Total Expenses</p>
                                ...
                                <div class="col-md-8">
                                    <div class="rounded-col">
                                        <p class="headline-small">History</p>
                                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mt-4 gy-3">
                                            <div class="col">
                                                <div class="card history">
                                                    <div class="global-img rounded-0">
                                                        <img src="../assets/img/card.png" class="card-img-top" alt="...">
                                                    </div>
                                                    <div class="card-body">
                                                        <h5 class="card-title">Restaurant</h5>
                                                        <p class="card-text">Jollof rice with 3 chicken laps</p>
                                                        <h4 class="card-title mt-3 fw-bold text-p">₦5,000.00</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="card history">
                                                    <div class="global-img rounded-0">
                                                        <img src="../assets/img/Frame 1000003264.png" class="card-img-top" alt="...">
                                                    </div>
                                                    <div class="card-body">
                                                        <h5 class="card-title">Restaurant</h5>
                                                        <p class="card-text">Jollof rice with 3 chicken laps and Malt</p>
                                                        <h4 class="card-title mt-3 fw-bold text-p">₦5,000.00</h4>
                                                    </div>
                                                </div>
                                            </div>
