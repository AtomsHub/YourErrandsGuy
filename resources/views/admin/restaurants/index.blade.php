...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>YourErrandsGuy - Restaurants</title>
        ...
        <section class="main-content flex-grow-1">
            <div class="p-0 h-100 d-flex align-items-stretch">
                ...
                <div class="dashboard-content p-3 p-md-4">
                    ...
                    <h5 class="headline-small pt-4 mb-3">Restaurants List</h5>
                        ...
                        <div class="col">
                            <div class="rounded-col table-responsive">
                                <table class="table table-hover" id="ride">
                                    ...
                                    <tbody>
                                        <tr onclick="window.location.href='restaurant.html'">
                                            <td>#675895</td>
                                            <td>23 Jul 2024 12:32 AM</td>
                                            <td>Iya Rerunner Restaurant</td>
                                            <td>Aroro makinde, Ibadan.</td>
                                            <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas eos repellat dolore tenetur impedit amet cupiditate quas eaque explicabo iste, assumenda commodi iure facilis error? Quis numquam autem possimus nobis.</td>
