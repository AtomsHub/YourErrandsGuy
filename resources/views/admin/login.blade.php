...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>YourErrandsGuy - Login</title>
        ...
        <div class="d-lg-flex align-items-center gap-5 container">
            ...
            <div class="col">
                <div class="rounded-col">
                    ...
                    <form id="loginForm" class="vstack gap-4" method="post" action="{{ route('admin.login.post') }}">
                        @csrf
                        <input id="email" name="email" class="form-control" type="email" placeholder="Email Address" required>
                        <input id="password" name="password" class="form-control" type="password" placeholder="Password" required>
                        <button type="submit" class="btn-one btn d-flex align-items-center justify-content-center" id="submit-btn">
